...
// Define the Vehicle class before ISimOutput and its derived classes
class Vehicle {
private:
...
public:
    ...
    virtual ~ISimOutput() {} // Adding a virtual destructor
};
...
int main() {
    // Create instances of MetricOutput and ImperialOutput
    ISimOutput* metricOutput = new MetricOutput();
    ISimOutput* imperialOutput = new ImperialOutput();

    // Use MetricOutput
    ISimOutput* simOutput = metricOutput;
